...
import '../../controller/games/tests.dart';
...
part 'supportTeacher/tests/games/coin/coin.dart';
part 'supportTeacher/tests/games/coin/select.dart';
part 'supportTeacher/tests/games/connect_dots/home.dart';
