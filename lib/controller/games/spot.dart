...
class SpotGameContImp extends SpotGameCont {
  ...
  CountdownController countdownController2 =
      CountdownController(autoStart: true);
  CountdownController countdownController3 =
      CountdownController(autoStart: true);
  CountdownController countdownController4 =
      CountdownController(autoStart: true);
  CountdownController countdownController5 =
      CountdownController(autoStart: true);
  CountdownController countdownController6 =
      CountdownController(autoStart: true);
  CountdownController countdownController7 =
      CountdownController(autoStart: true);
  CountdownController countdownController8 =
      CountdownController(autoStart: true);
  CountdownController countdownController9 =
      CountdownController(autoStart: true);
  CountdownController countdownController10 =
      CountdownController(autoStart: true);
  CountdownController countdownController11 =
      CountdownController(autoStart: true);
  CountdownController countdownController12 =
      CountdownController(autoStart: true);
  CountdownController countdownController13 =
      CountdownController(autoStart: true);
  CountdownController countdownController14 =
      CountdownController(autoStart: true);
  CountdownController countdownController15 =
      CountdownController(autoStart: true);
  ...
  getLevel() async {
    try {
      ...
      if (loginData != null) {
        ...
        var levelResponse =
            await requests.postData(levelRequest, ApiLinks.spotGameLevel);
        ...
        Get.defaultDialog(
            ...
            confirm: SizedBox(
              ...
              child: ElevatedButton(
                style: ButtonStyle(
                  backgroundColor:
                      MaterialStateProperty.all<Color>(greenSuccess),
                  shape: MaterialStateProperty.all<RoundedRectangleBorder>(
                    RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(10),
                    ),
